        ...
        {isRestaurant &&
          <div className="commentSection">
            <div className="topComment">
              ...
              <p>({details.rating}/5 de {details.reviews} opiniones)</p>
              </div>
             
            </div>
            <div className="userComments">
              <div className="comment">
              <span>Cristian A.</span>
            ...
            <button className="moreComments">Ver más</button>
           <div className="bottomComments">
              ...
              <Rating
                ...
                <textarea onChange={handleInputChange} value={inputText} name="" id="" cols="50" rows="5"></textarea>
